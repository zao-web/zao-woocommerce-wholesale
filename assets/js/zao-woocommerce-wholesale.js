			...
			results = this.products.filter(function (product) {
				...
				return _.find(self.searchParams, function (col) {
					...
					if ('categories' === col && _.isArray(prodVal)) {
						var foundCat = _.find(prodVal, function (cat) {
