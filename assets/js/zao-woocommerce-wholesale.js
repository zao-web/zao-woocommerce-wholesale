...
(function (window, document, $, app, undefined) {
	...
	app.init = function () {
		...
		setTimeout(function () {
			return app.$.select.select2('open');
		}, 1000);
